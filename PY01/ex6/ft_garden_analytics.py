...
class Flower(Plant):
    ...
    def show(self):
        ...
        print(f"{self.name} is blooming beautifully!") if (self._bloomed) else print(f"{self.name} has not bloomed yet")
...
if __name__ == "__main__":
    ...
    print(f"Is 30 days more than a year? -> " f"{Plant.is_older_than_year(30)}")
    print( f"Is 400 days more than a year? -> " f"{Plant.is_older_than_year(400)}")
